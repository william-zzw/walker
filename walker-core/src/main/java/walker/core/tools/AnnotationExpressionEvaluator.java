...
public class AnnotationExpressionEvaluator<T> extends CachedExpressionEvaluator {
    ...
    /**
     * Create the suitable {@link EvaluationContext} for the specified event
     * handling on the specified method.
     */
